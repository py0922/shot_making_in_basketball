...
total_epoches =100
train_evaluation_step = 2  # Evaluate on the training batch after some steps.
val_evaluation_epoch = 2  # Evaluate on the whole validation dataset after some steps. Set to None to evaluate every epoch.
